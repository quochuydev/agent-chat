// ============================================================
//  cappuai_flow — background service worker
...
chrome.runtime.onInstalled.addListener(() => {
  chrome.sidePanel
    ...
    .catch((e) => console.warn("[cappuai_flow] setPanelBehavior:", e));
});
...
chrome.debugger.onDetach.addListener((source) => {
  if (source.tabId === attachedTab) {
    console.warn("[cappuai_flow] debugger bị tách khỏi tab", source.tabId);
    attachedTab = null;
  }
});
